...
public class RealtimeLocation extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    */
    ...
    public void onDestroy() {
        Log.e("LocationT", "Service Stopped");
        stopService = true;
    ...
    private void StartForeground() {
        Intent intent = new Intent(context, HomeOffline.class);
